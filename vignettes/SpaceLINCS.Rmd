...
![Mechanism-of-action of the top enriched drugs](images/plotMOA-drugClass-WvsU.png "Drug class"){width="100%"}
![Target gene enrichment of the top enriched drugs](images/plotMOA-targetGene-WvsU.png "Target gene"){width="100%"}
